package com.hedgehog.ar154.result
...
import com.hedgehog.ar154.databinding.FragmentResultBinding
...
class ResultFragment(
    ...
    private fun powerResult() {
        ...
        binding.apply {
            ...
            tvSecond.text = getString(R.string.time_to_work, ((minutesOld.toFloat() / minutesNow.toFloat()) * 100).toInt())
