...
import ar.cleaner.second.pf.databinding.FragmentBatteryBinding
import ar.cleaner.second.pf.extensions.*
import ar.cleaner.second.pf.ui.dialogs.DialogBluetoothPermission
import ar.cleaner.second.pf.ui.dialogs.DialogWriteSettings
import ar.cleaner.second.pf.ui.menu.toHours
import ar.cleaner.second.pf.ui.menu.toMinutes
...
class BatteryFragment : Fragment(R.layout.fragment_battery) {
    ...
    private fun renderEvents(event: BaseEvent) {
        when (event) {
            is ar.cleaner.second.pf.utils.events.RuntimePermission -> {
